...
LDLIBSOPTIONS=../XmlCmd/dist/Release/GNU-Linux-x86/libxmlcmd.a
...
${OBJECTDIR}/XmlCmdImageBlur.App.o: XmlCmdImageBlur.App.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I. -I../XmlCmd -I../rapidxml-1.13 -MMD -MP -MF $@.d -o ${OBJECTDIR}/XmlCmdImageBlur.App.o XmlCmdImageBlur.App.cpp

${OBJECTDIR}/XmlCmdImageBlur.Config.Reader.o: XmlCmdImageBlur.Config.Reader.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I. -I../XmlCmd -I../rapidxml-1.13 -MMD -MP -MF $@.d -o ${OBJECTDIR}/XmlCmdImageBlur.Config.Reader.o XmlCmdImageBlur.Config.Reader.cpp

${OBJECTDIR}/XmlCmdImageBlur.Config.Settings.o: XmlCmdImageBlur.Config.Settings.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I. -I../XmlCmd -I../rapidxml-1.13 -MMD -MP -MF $@.d -o ${OBJECTDIR}/XmlCmdImageBlur.Config.Settings.o XmlCmdImageBlur.Config.Settings.cpp

${OBJECTDIR}/XmlCmdImageBlur.Layer.o: XmlCmdImageBlur.Layer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I. -I../XmlCmd -I../rapidxml-1.13 -MMD -MP -MF $@.d -o ${OBJECTDIR}/XmlCmdImageBlur.Layer.o XmlCmdImageBlur.Layer.cpp

${OBJECTDIR}/XmlCmdImageBlur.Pixel.o: XmlCmdImageBlur.Pixel.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I. -I../XmlCmd -I../rapidxml-1.13 -MMD -MP -MF $@.d -o ${OBJECTDIR}/XmlCmdImageBlur.Pixel.o XmlCmdImageBlur.Pixel.cpp

${OBJECTDIR}/XmlCmdImageBlur.Row.o: XmlCmdImageBlur.Row.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I. -I../XmlCmd -I../rapidxml-1.13 -MMD -MP -MF $@.d -o ${OBJECTDIR}/XmlCmdImageBlur.Row.o XmlCmdImageBlur.Row.cpp
