   ...
   namespace Config
   {
      ...
      Settings Reader::Parse()
      {
         ...
         if ( current_node )
         {
            ...
            const char lsXMLNamespace[] = { "http://www.XmlCommandLine.org/lsXml/" };
            ...
            result.recursive = ParseBool( ReadNode( current_node, XmlNamespacePrefix, "Recursive" ) );
            result.dotdot = ParseBool( ReadNode( current_node, XmlNamespacePrefix, "DotDot" ) );
            result.Context = ParseBool( ReadNode( current_node, XmlNamespacePrefix, "Context" ) );
         }
