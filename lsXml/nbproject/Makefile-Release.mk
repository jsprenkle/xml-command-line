...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/lsXml.exe: ../XmlCmd/dist/Release/MinGW-Windows/libxmlcmd.a
...
${OBJECTDIR}/_ext/2110782463/lsXml.Config.Reader.o: ../lsXml/lsXml.Config.Reader.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -I../XmlCmd -I../rapidxml-1.13 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/2110782463/lsXml.Config.Reader.o ../lsXml/lsXml.Config.Reader.cpp

${OBJECTDIR}/_ext/2110782463/lsXml.Config.Settings.o: ../lsXml/lsXml.Config.Settings.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/2110782463
	${RM} $@.d
	$(COMPILE.cc) -O2 -I../XmlCmd -I../rapidxml-1.13 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/2110782463/lsXml.Config.Settings.o ../lsXml/lsXml.Config.Settings.cpp
