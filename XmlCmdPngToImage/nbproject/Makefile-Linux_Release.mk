...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/xmlcmdpngtoimage: ../lodepng/dist/Linux_Release/GNU-Linux-x86/liblodepng.a

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/xmlcmdpngtoimage: ../XmlCmd/dist/Linux_Release/GNU-Linux-x86/libxmlcmd.a
...
${OBJECTDIR}/_ext/41244727/XmlCmdPngToImage.App.o: ../XmlCmdPngToImage/XmlCmdPngToImage.App.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -I. -I../rapidxml-1.13 -I../XmlCmd -I../lodepng -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/41244727/XmlCmdPngToImage.App.o ../XmlCmdPngToImage/XmlCmdPngToImage.App.cpp

${OBJECTDIR}/_ext/41244727/XmlCmdPngToImage.Config.Reader.o: ../XmlCmdPngToImage/XmlCmdPngToImage.Config.Reader.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/41244727
	${RM} $@.d
	$(COMPILE.cc) -g -I. -I../rapidxml-1.13 -I../XmlCmd -I../lodepng -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/41244727/XmlCmdPngToImage.Config.Reader.o ../XmlCmdPngToImage/XmlCmdPngToImage.Config.Reader.cpp

${OBJECTDIR}/_ext/41244727/XmlCmdPngToImage.Config.Settings.o: ../XmlCmdPngToImage/XmlCmdPngToImage.Config.Settings.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/41244727
	${RM} $@.d
	$(COMPILE.cc) -g -I. -I../rapidxml-1.13 -I../XmlCmd -I../lodepng -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/41244727/XmlCmdPngToImage.Config.Settings.o ../XmlCmdPngToImage/XmlCmdPngToImage.Config.Settings.cpp

${OBJECTDIR}/main.o: main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I. -I../rapidxml-1.13 -I../XmlCmd -I../lodepng -MMD -MP -MF $@.d -o ${OBJECTDIR}/main.o main.cpp
