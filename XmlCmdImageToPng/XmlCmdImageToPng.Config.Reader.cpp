   ...
   namespace Config
   {
      ...
      Settings Reader::Parse()
      {
         ...
         if ( current_node )
         {
            ...
            const char lsXMLNamespace[] = { "http://www.XmlCommandLine.org/XmlCmdImageToPng/" };
...
//            result.Red = ::atoi( ReadNode( current_node, XmlNamespacePrefix, "Content" ) );
//            result.Green = ::atoi( ReadNode( current_node, XmlNamespacePrefix, "Content" ) );
//            result.Blue = ::atoi( ReadNode( current_node, XmlNamespacePrefix, "Content" ) );
//            result.Alpha = ::atoi( ReadNode( current_node, XmlNamespacePrefix, "Content" ) );

            result.OutputFile = ReadNode( current_node, XmlNamespacePrefix, "OutputFile" );
            result.InputFile = ReadNode( current_node, XmlNamespacePrefix, "InputFile" );
         }
