...
LDLIBSOPTIONS=../XmlCmd/dist/Debug/MinGW-Windows/libxmlcmd.a

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/XmlUnion.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/XmlUnion.exe: ../XmlCmd/dist/Debug/MinGW-Windows/libxmlcmd.a
...
${OBJECTDIR}/XmlUnion.App.o: XmlUnion.App.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I. -I../XmlCmd -I../rapidxml-1.13 -MMD -MP -MF $@.d -o ${OBJECTDIR}/XmlUnion.App.o XmlUnion.App.cpp

${OBJECTDIR}/XmlUnion.Config.Reader.o: XmlUnion.Config.Reader.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I. -I../XmlCmd -I../rapidxml-1.13 -MMD -MP -MF $@.d -o ${OBJECTDIR}/XmlUnion.Config.Reader.o XmlUnion.Config.Reader.cpp

${OBJECTDIR}/XmlUnion.Config.Settings.o: XmlUnion.Config.Settings.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I. -I../XmlCmd -I../rapidxml-1.13 -MMD -MP -MF $@.d -o ${OBJECTDIR}/XmlUnion.Config.Settings.o XmlUnion.Config.Settings.cpp
