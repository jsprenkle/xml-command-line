...
${OBJECTDIR}/_ext/23690359/XmlCmd.Image.o: ../XmlCmdImage/XmlCmd.Image.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -I. -I../XmlCmd -I../rapidxml-1.13 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/23690359/XmlCmd.Image.o ../XmlCmdImage/XmlCmd.Image.cpp

${OBJECTDIR}/_ext/23690359/XmlCmd.ImageReader.o: ../XmlCmdImage/XmlCmd.ImageReader.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/23690359
	${RM} $@.d
	$(COMPILE.cc) -g -I. -I../XmlCmd -I../rapidxml-1.13 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/23690359/XmlCmd.ImageReader.o ../XmlCmdImage/XmlCmd.ImageReader.cpp

${OBJECTDIR}/_ext/23690359/XmlCmd.ImageWriter.o: ../XmlCmdImage/XmlCmd.ImageWriter.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/23690359
	${RM} $@.d
	$(COMPILE.cc) -g -I. -I../XmlCmd -I../rapidxml-1.13 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/23690359/XmlCmd.ImageWriter.o ../XmlCmdImage/XmlCmd.ImageWriter.cpp
