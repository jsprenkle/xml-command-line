...
namespace File
{
   ...
   // <editor-fold defaultstate="collapsed" desc="WriterIterator">

   WriterIterator::WriterIterator( Writer& wrt )
      : _Writer( wrt )
   {
   }

   WriterIterator& WriterIterator::operator++()
   {
      return *this;
   }

   WriterIterator& WriterIterator::operator++( int )
   {
      return *this;
   }
   ...
   WriterIterator& WriterIterator::operator=( WriterIterator it )
   {
      _Writer = it._Writer;
      return *this;
   }

   WriterIterator& WriterIterator::operator=(char c)
   {
